namespace AtomicCore.BlockChain.BscscanAPI
{
    ...
    public interface IBscGethProxy
    {
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        BscRpcBlockSimpleJson GetBlockSimpleByNumber(long blockNumber, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        BscRpcBlockFullJson GetBlockFullByNumber(long blockNumber, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        int GetBlockTransactionCountByNumber(long blockNumber, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        BscRpcTransactionJson GetTransactionByHash(string txhash, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        string Call(string to, string data, BscBlockTag tag = BscBlockTag.Latest, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        string GetCode(string address, BscBlockTag tag = BscBlockTag.Latest, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        string GetStorageAt(string address, string position, BscBlockTag tag = BscBlockTag.Latest, BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
        ...
        /// <param name="expiredSeconds">expired seconds</param>
        /// <returns></returns>
        long GasPrice(BscNetwork network = BscNetwork.BscMainnet, BscscanCacheMode cacheMode = BscscanCacheMode.None, int expiredSeconds = 10);
